...
<tr class="block md:table-row bg-white md:bg-transparent mb-4 md:mb-0 border md:border-0 border-slate-100 rounded-2xl md:rounded-none overflow-hidden hover:bg-slate-50 transition-colors group">
    ...
    <td class="block md:table-cell px-4 py-3 border-b md:border-0 border-slate-50">
        <div class="flex items-center justify-between md:justify-start gap-4">
            <div class="md:hidden text-[10px] font-black text-slate-400 uppercase tracking-widest min-w-17.5">Nama</div>
    ...
    <td class="block md:table-cell px-4 py-3 border-b md:border-0 border-slate-50">
        <div class="flex items-center justify-between md:justify-start gap-4">
            <div class="md:hidden text-[10px] font-black text-slate-400 uppercase tracking-widest min-w-17.5">Terdaftar</div>
            <div class="text-slate-600 text-[11px] font-medium text-right md:text-left">
        ...
        <div class="flex items-center justify-between md:justify-center gap-4">
            ...
            <div class="flex items-center justify-end md:justify-center gap-2">
                <button
                    ...
                    class="btn-edit-password p-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl shadow-lg shadow-blue-100 transition-all active:scale-95"
                    title="Edit Password">
