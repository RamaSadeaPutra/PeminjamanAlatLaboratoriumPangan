...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
    ...
    <div class="p-4 md:p-6 border-b border-slate-100 bg-slate-50/50 space-y-4">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h2 class="text-xl font-bold text-slate-800">Daftar Alat Laboratorium Tersedia</h2>
        ...
        <div class="flex flex-wrap lg:flex-nowrap items-center gap-3">
            ...
            <div class="relative flex-1 min-w-32.5">
                <select id="filter-condition-admin"
                    class="w-full pl-4 pr-10 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all appearance-none cursor-pointer">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    [labSelect, categorySelect, conditionSelect].forEach(el =>
        el.addEventListener('change', performAdminFilter)
    );
